...
def get_filters():
    ...
    while day not in ['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday', 'all']:
        day = input('please insert a valid value!').strip().lower()
    print('-'*40)
